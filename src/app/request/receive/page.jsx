        ...
        <>
            {requests.length > 0 ? (
                requests.map((request) => (
                    <div
                        key={request._id}
                        className="bg-[#111] border border-white/[0.08] rounded-[16px] p-5 sm:p-6 space-y-5 m-5"
                    >
            ...
            "
                ...
                <div className="text-center py-24">
                    ...
                    <p className="text-[#333] text-[12px] mt-1">When someone sends you a request, it'll appear here</p>
                </div>
            )}
        </>
    )
